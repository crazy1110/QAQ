...
class DynamicFieldSet extends React.Component {
  ...
  handleSubmitText=(values,title,rule,require)=>{
        ...
        return (
          ...
          >
            {getFieldDecorator(inputType, {
              ...
              <TextArea rowls={4} placeholder="passenger name" style={{ width: '60%', marginRight: 8 }} /> ,
            )}
    ...
    return (
      <div>
        ...
        <div>
          ...
          >
            <InputModel handleSubmitText={this.handleSubmitText} formType={'text'} />
